          ...
          <div className="md1000:w-[60%] md1000:flex md1000:flex-col md1000:mx-auto min800:w-[90%] min620:w-full">
            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-y-20 min620:grid-cols-1 min620:mx-auto">
              <div className="flex flex-col relative">
                ...
                <span className="bg-signature-gold w-[50px] h-[4px] absolute top-[33px]"></span>
              ...
              <div className="flex flex-col relative">
                ...
                <div className="text-[18px] font-medium text-black flex gap-5">
                  <i className="fa-brands fa-facebook-f px-[16px] py-[13px] bg-[#f4f4f4] rounded-full cursor-pointer hover:bg-signature-gold ease-in duration-200 hover:text-white"></i>
                  <i className="fa-brands fa-twitter p-[13.5px] bg-[#f4f4f4] rounded-full cursor-pointer hover:bg-signature-gold ease-in duration-200 hover:text-white"></i>
                  ...
                  <i className="fa-brands fa-pinterest-p p-[13.5px] bg-[#f4f4f4] rounded-full cursor-pointer hover:bg-signature-gold ease-in duration-200 hover:text-white"></i>
                </div>
              </div>
            </div>
          </div>
