const translations = {
  translations: {
    ...
    aboutUs: {
      ...
      description:
        "Dondoca, onde você encontra beleza e bem estar! Fundado por mãe e filha, Juarezita e Gisely, este salão é o destino ideal para quem procura um tratamento de beleza de alta qualidade e um ambiente descontraído e amigável. Com uma equipe de profissionais experientes e altamente qualificados.",
      team: {
        title: "Equipe",
    ...
    contactUs: {
      ...
      phoneNumber: "(11)93500-1578",
      phoneNumberInteger: "11935001578",
