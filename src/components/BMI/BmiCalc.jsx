        ...
        <div className="container page-padding ">
          ...
          <div className="text-white w-[52rem] min620:w-[100%] relative">
            <h2 className="text-[4rem] font-bold leading-[1.1] mb-8">
              ...
              <span className="text-signature-gold">BMI</span>
            </h2>
            ...
            <div className="flex flex-col">
              ...
              <p className="mt-10 gap-3 text-[16px] font-medium flex items-center w-full ">
                ...
                <span className="w-1/2">
                  Your weight is: &nbsp;
                  <span className="text-signature-gold">{message}</span>
                </span>
              </p>
              <button
                onClick={calcBmi}
                ...
                type="submit"
                className="text-[15px] uppercase font-bold mt-10 bg-[#323232] w-[15rem] h-[5rem] hover:bg-signature-gold"
              >
                Calculate
              </button>
            </div>
